...
# TODO: DELETE THIS
# This project is too simple and not representative of my current capabalities.
# I'll swap it (soon™) with something more interesting...

def dash_compound_calc(flask_app):
    dash_app = Dash(
        __name__,
        server=flask_app,
