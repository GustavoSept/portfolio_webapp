...
print("\n\n\n\nwe got here! we got here! we got here! we got here! we got here! \n\n\n\n")

@main_bp.route('/')
@main_bp.route('/home')
def pg_home():
    print(f'we arrive at home page!')
    # List of projects
    # projects = [
    #     {
    ...
    return "We rendered home!"

# @main_bp.route('/contact')
# def pg_contact():
#     return render_template('contact.html')

# @main_bp.route('/spreadsheets')
# def pg_spreadsheets():
...
# @main_bp.route('/projects/economic_freedom_analysis')
# def pg_EF_Analysis():
#     return render_template('projects_economicFreedomAnalysis.html')

# @main_bp.route('/projects/compoundCalculator')
# def pg_compoundCalc():
#     return render_template('projects_compoundInterestCalc.html')

# @main_bp.route('/projects/portfolioProjection')
...
# @main_bp.route('/delete-investment', methods=['POST'])
